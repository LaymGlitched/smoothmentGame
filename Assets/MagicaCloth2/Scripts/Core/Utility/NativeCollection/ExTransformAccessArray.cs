...
namespace MagicaCloth2
{
    ...
    public class ExTransformAccessArray : IDisposable
    {
        ...
        public int Add(Transform element)
        {
            ...
            // Fix: Extract the 32-bit hash code to avoid the obsolete casting warning
            int id = element.GetEntityId().GetHashCode();
        ...
        public bool Exist(Transform element)
        {
            ...
            // Fix: Extract the 32-bit hash code to avoid the obsolete casting warning
            return indexDict.ContainsKey(element.GetEntityId().GetHashCode());
        }
