...
namespace MagicaCloth2
{
    ...
    public partial class MagicaCloth : ClothBehaviour, IValid
    {
        ...
        public override int GetMagicaHashCode()
        {
            ...
            // Fix: Call GetHashCode() directly on the EntityId struct to safely return a 32-bit integer
            hash += isActiveAndEnabled ? GetEntityId().GetHashCode() : 0; // component active.
            return hash;
        }
    }
}
