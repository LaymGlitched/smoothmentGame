...
namespace KS.SceneFusion2.Unity.Editor
{
    ...
    public class sfPrefabStageMap
    {
        ...
        {
            return stageObject == null ? null : GetPrefabObject<T>(stageObject.GetId());
        }
        ...
        private void AddMapping(GameObject stageObject, GameObject prefabObject)
        {
            ...
            m_stageToPrefabMap[stageObject.GetId()] = prefabObject;
            ...
            for (int i = 0; i < stageComponents.Length; i++)
            {
                ...
                {
                    m_stageToPrefabMap[stageComponents[i].GetId()] = prefabComponents[i];
                }
            }
