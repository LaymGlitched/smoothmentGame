...
namespace KS.SceneFusion2.Unity.Editor
{
    ...
    public class sfIconDrawer
    {
        ...
        /// <param name="entityId">entityId of game object to draw icons for.</param>
        /// <param name="area">area the game object label was drawn in.</param>
        private void DrawHierarchyItem(EntityId entityId, Rect area)
        {
            UObject uobj = EditorUtility.EntityIdToObject(entityId);
            if (uobj == null)
            {
                return;
            }
        ...
        /// <param name="entityId">entityId of asset to draw icons for.</param>
        /// <param name="area">area the asset was drawn in.</param>
        private void DrawProjectItem(EntityId entityId, Rect area)
        {
            UObject asset = EditorUtility.EntityIdToObject(entityId);
