    ...
    public class sfPrefabEventManager
    {
        ...
        private void TryAddCreateEvent(GameObject gameObject)
        {
            ...
            CreateGameObjectHierarchyEventArgs data = 
                new CreateGameObjectHierarchyEventArgs(prefab.GetEntityId(), prefab.scene);
#else
            CreateGameObjectHierarchyEventArgs data = 
        ...
        private void TryAddDeleteEvent(int instanceId)
        {
            ...
            DestroyGameObjectHierarchyEventArgs data =
                new DestroyGameObjectHierarchyEventArgs(prefab.GetEntityId(), prefab.scene);
#else
            DestroyGameObjectHierarchyEventArgs data =
        ...
        private void TryAddPropertiesChangeEvent(UObject uobj)
        {
            ...
            ChangeGameObjectOrComponentPropertiesEventArgs data = 
                new ChangeGameObjectOrComponentPropertiesEventArgs(prefab.GetEntityId(), new Scene());
#else
            ChangeGameObjectOrComponentPropertiesEventArgs data = 
        ...
        private void TryAddParentChangeEvent(GameObject gameObject)
        {
            ...
            ChangeGameObjectParentEventArgs data =
                new ChangeGameObjectParentEventArgs(prefab.GetEntityId(), prefab.scene, default, prefab.scene, default);
#else
            ChangeGameObjectParentEventArgs data =
...
#if UNITY_6000_0_OR_NEWER
            ChangeGameObjectParentEventArgs data = new ChangeGameObjectParentEventArgs(default, prefab.scene, 
                prefab.GetEntityId(), prefab.scene, prefab.GetEntityId());
#else
        ...
        private void TryAddStructureChangeEvent(GameObject gameObject)
        {
            ...
            ChangeGameObjectStructureEventArgs data =
                new ChangeGameObjectStructureEventArgs(prefab.GetEntityId(), prefab.scene);
#else
            ChangeGameObjectStructureEventArgs data =
        ...
        private void TryAddHierarchyStructureChangeEvent(GameObject gameObject)
        {
            ...
            ChangeGameObjectStructureHierarchyEventArgs data =
                new ChangeGameObjectStructureHierarchyEventArgs(prefab.GetEntityId(), prefab.scene);
#else
            ChangeGameObjectStructureHierarchyEventArgs data =
        ...
        private void TryAddPropertyModifications(UndoPropertyModification[] modifications)
        {
            ...
            for (int i = 0; i < modifications.Length; i++)
            {
                ...
                else
                {
                    ...
                    TryAddModifiedPrefab(modification.currentValue.target.GetId());
                }
            }
        ...
        {
#if UNITY_6000_0_OR_NEWER
            string path = AssetDatabase.GetAssetPath(EditorUtility.EntityIdToObject(instanceId.ToEntityId()));
#else
